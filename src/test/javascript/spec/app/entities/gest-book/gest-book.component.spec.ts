...
import { GestBookComponent } from 'app/entities/gest-book/gest-book.component';
...
describe('Component Tests', () => {
  describe('GestBook Management Component', () => {
    let comp: GestBookComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GestBookComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.gestBooks && comp.gestBooks[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

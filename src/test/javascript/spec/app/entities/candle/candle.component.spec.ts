...
import { CandleComponent } from 'app/entities/candle/candle.component';
import { CandleService } from 'app/entities/candle/candle.service';
import { Candle } from 'app/shared/model/candle.model';

describe('Component Tests', () => {
  describe('Candle Management Component', () => {
    let comp: CandleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CandleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.candles && comp.candles[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

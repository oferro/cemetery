package com.oferr.cemetery.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.oferr.cemetery.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.oferr.cemetery.repository.UserRepository.USERS_BY_EMAIL_CACHE);
